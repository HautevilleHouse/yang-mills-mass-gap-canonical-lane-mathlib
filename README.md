# Yang Mills Mass Gap — Canonical Lane Mathlib
...
```bash
git clone https://github.com/HautevilleHouse/yang-mills-mass-gap-canonical-lane-mathlib.git
cd yang-mills-mass-gap-canonical-lane-mathlib
lake exe
lake build
```
